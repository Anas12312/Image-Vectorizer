...
function App() {
  ...
  const imgFilehandler = (e) => {
    if (e.target.files[0].type === 'image/jpeg' || e.target.files[0].type === 'image/png' || e.target.files[0].type === 'image/jpg') {
      ...
      console.log("Image Type must be JPG, JPEG or PNG")
    }
  }
      ...
      {convertedImage == null ? (
        image ? (
          loading ? (
            ...
            <div className="h-[55%] mt-32 flex flex-col justify-center items-center">
              ...
              <div onClick={vectorize} className="mb-10 w-full min-w-[40rem] mt-3 py-3 text-xl text-white font-bold tracking-[0.8rem] bg-blue-500 hover:bg-blue-700 rounded-xl flex justify-center cursor-pointer">VECTORIZE</div>
              <div className="py-5">Created By AZ &copy; 2024</div>
            </div>
          )
        ) : (
